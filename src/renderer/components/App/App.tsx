...
import { LangBtnProps, Store } from './App.interface';
...
export const Home: React.FC<NoProps> = () => {
...
export const NotFound: React.FC<NoProps> = () => {
  const { t } = useTranslation();
...
export const Page2: React.FC<NoProps> = () => {
  const { t } = useTranslation();
